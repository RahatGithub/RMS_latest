...
urlpatterns = [
    ...
    path('delete_student/<str:batch_no>/<str:reg_no>', views.delete_student, name="delete_student"),
    ...
    path('update_student/<str:batch_no>/<str:reg_no>', views.update_student, name="update_student"),
    ...
    path('assessments/<str:batch_no>/<int:semester_no>/<str:course_code>/attendance', views.add_attendance, name="add_attendance")
]